...
az \ref{sec:ides} alfejezetben fogjuk megtekinteni, illetve a dolgozat elmagyarázza, hogy ezek a megoldások miért nem elégségesek.
...
(ezeket a sajátosságokat majd bővebben bemutatjuk a \ref{sec:rust} fejezetben), és amik figyelmeztetnek a gyakori Rust programozási hibákra.
