...
A \textit{Rust} egy multi-paradigmájú rendszerprogramozási nyelv,\cite{oldpage:main},
...
majd felállított egy csapatot, aminek feladata az volt, hogy a nyelven tovább dolgozzon azzal a céllal, hogy beépíthessék azt az akkor fejlesztés alatt álló Servo projektjükbe.\cite{oldpage:faq:project, interview:graydon}
