...
Az ilyen blokkok mindig meg vannak jelölve az \texttt{unsafe} megnevezéssel, így egy egyszerű keresés a fáljokban rámutat, hol lehetnek nyers mutatók.\cite{compare:rust:raw_pointers}
